...
STRIPE_GENERAL_ADMISSION_PRICE_ID=price_1TagyX949kCD6D1UPkI7s3Kf
STRIPE_BED_SPACE_PRICE_ID=price_1TagyX949kCD6D1Uav8NFRFU
...
5. Confirm `STRIPE_SECRET_KEY` is a live-mode key when selling live tickets, and that the configured price IDs are active live-mode, one-time prices in the same Stripe account.
